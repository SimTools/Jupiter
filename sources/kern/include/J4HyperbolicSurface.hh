// $Id$
#ifndef __J4HYPERBOLICSURFACE__
#define __J4HYPERBOLICSURFACE__
//*************************************************************************
//* --------------------
//* J4HyperbolicSurface
//* --------------------
...
class J4HyperbolicSurface : public J4VSurface
{
public:
                       
   J4HyperbolicSurface(const G4String         &name,
...
inline
G4double J4HyperbolicSurface::GetRhoAtPZ(const G4ThreeVector &p, G4bool isglobal) const 
{
