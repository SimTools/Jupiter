...
{   
  if(!GetLV()){
    ...
    // SetVisAttribute ---------------
    //PaintLV(_IRVISATT_, G4Color(1, 1, 1));
    PaintLV(FALSE, G4Color(1, 1, 1));
...
#if 1
    J4IRQC1MField* qc1field = new J4IRQC1MField();

    fQC1R = new J4IRQC1(this,1,2,0,-1);
    fQC1R->SetMField(qc1field);
    Register(fQC1R);
    fQC1R->InstallIn(this);
    SetDaughter(fQC1R);

    fQC1L = new J4IRQC1(this,1,2,1,-1,true);
    fQC1L->SetMField(qc1field);
    Register(fQC1L);
    ...
    J4IRQC2MField* qc2field = new J4IRQC2MField();

    fQC2R = new J4IRQC2(this,1,2,0,-1);
    fQC2R->SetMField(qc2field);
    fQC2L = new J4IRQC2(this,1,2,1,-1,true);
    fQC2L->SetMField(qc2field);
    Register(fQC2R);
    Register(fQC2L);
