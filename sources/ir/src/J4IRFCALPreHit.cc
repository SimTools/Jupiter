...
J4IRFCALPreHitAllocator J4IRFCALPreHit::fgPreHitAllocator;
J4Output*            J4IRFCALPreHit::fgPreOutput = 0;
 
//=========================================================================
//* constructor -----------------------------------------------------------
J4IRFCALPreHit::J4IRFCALPreHit( J4VComponent*         detector,  // He is in "location" now
...
void J4IRFCALPreHit::Output( G4HCofThisEvent* /* PreHCTE */ )
{
  ...
  if ( !ofs.good() ) {
    const G4String& errorMessage = "J4IRFCALPreHit::Output(): write error.";
